...
public:
    ...
    void callAddTwoInts(int a, int b)
    {
        ...
        client_->async_send_request(
            request, std::bind(&AddTwoIntsClientNode::callbackCallAddTwoInts, this, std::placeholders::_1));
    }
...
int main(int argc, char **argv)
{
    ...
    node->callAddTwoInts(3, 6);
    node->callAddTwoInts(9, 6);
    node->callAddTwoInts(3, 10);
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}